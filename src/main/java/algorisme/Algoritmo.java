...
public class Algoritmo {
    ...
    private List<SimpleEntry<String, Boolean>> computarMejorPalabraDelAtril(Dawg dawg, String[] atril, int longitud, Tablero tablero ) {
        ...
        computarMejorPalabraDelAtrilAux(dawg.getRoot(),atril,usados,longitud,new ArrayList<>(), mejorPalabra, tablero);
    ...
    private void computarMejorPalabraDelAtrilAux(NodoDawg nodo, String[] atril, boolean[] usados, int restantes, List<SimpleEntry<String, Boolean>> camino, List<SimpleEntry<String, Boolean>> mejorPalabra, Tablero tablero) {
        if(!camino.isEmpty()) {
        ...
        for(int i = 0; i < atril.length; i++) {
            if(!usados[i]) {
                ...
                if(siguiente != null) {
                    ...
                    computarMejorPalabraDelAtrilAux(siguiente,atril,usados,restantes-1,camino,mejorPalabra, tablero);
