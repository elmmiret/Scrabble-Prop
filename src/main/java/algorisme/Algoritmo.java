...
public class Algoritmo {
    ...
    private List<SimpleEntry<SimpleEntry<String, Boolean>, SimpleEntry<Integer, Integer>>> computarPalabraAncla(Dawg dawg, Tablero tablero, SimpleEntry<Integer, Integer> ancla, String[] atril) {
        ...
        if(casillaCorrecta(x, y - 1)) {
            ...
            if(tablero[x][y - 1].getKey().getKey() != null) {
                ...
                List<SimpleEntry<SimpleEntry<String, Boolean>, SimpleEntry<Integer, Integer>>> parteIzquierda = new ArrayList<>();
                ...
                parteIzquierda = computarParteIzquierdaDelTablero(tablero,max_long,x,y);
            ...
            // Si la casilla no esta ocupada (parte izq. compuesta de letras del atril)
                ...
                List<List<SimpleEntry<SimpleEntry<String, Boolean>, SimpleEntry<Integer, Integer>>>> partesIzquierdas = new ArrayList<>();
                ...
                partesIzquierdas = computarParteIzquierdaDelAtril(dawg,atril,max_long,x,y);
    ...
    /**
     *  Función que devuelve la parte izquierda de un ancla que ya sabemos que a su izquierda tiene una casilla vacía
     * @param tablero
     * @param longitud
     * @param atril
     * @param x (fila ancla)
     * @param y (columna ancla)
     * @return
     */
    private List<List<SimpleEntry<SimpleEntry<String, Boolean>, SimpleEntry<Integer, Integer>>>> computarParteIzquierdaDelAtril(Dawg dawg, String[] atril, int longitud, int x, int y) {
        List<List<SimpleEntry<SimpleEntry<String, Boolean>, SimpleEntry<Integer, Integer>>>> partesIzquierdas = new ArrayList<>();

        int size = atril.length;

        // Backtracking para encontrar, dada la maxima longitud, todas las posibles combinaciones correctas
     ...
     * @return
     */
    private List<SimpleEntry<SimpleEntry<String, Boolean>, SimpleEntry<Integer, Integer>>> computarParteIzquierdaDelTablero(Tablero tablero, int longitud, int x, int y) {
        List<SimpleEntry<SimpleEntry<String, Boolean>, SimpleEntry<Integer, Integer>>> parteIzquierda = new ArrayList<>();
        ...
        for(int col = y - longitud; col < y; col++) {
            parteIzquierda.add( new SimpleEntry<>(new SimpleEntry<>(tablero[x][col].getKey().getKey(), false), new SimpleEntry<>(x, col)));
        }
     ...
     * @return
     */
    private List<SimpleEntry<SimpleEntry<String, Boolean>, SimpleEntry<Integer, Integer>>> computarParteDerechaAtril(Tablero tablero, Dawg dawg, List<List<SimpleEntry<SimpleEntry<String, Boolean>, SimpleEntry<Integer, Integer>>>> partesIzquierdas, String[] atril, int x, int y) {
     ...
     * @return
     */
    private List<SimpleEntry<SimpleEntry<String, Boolean>, SimpleEntry<Integer, Integer>>> computarParteDerechaTablero(Tablero tablero, Dawg dawg,  List<SimpleEntry<SimpleEntry<String, Boolean>, SimpleEntry<Integer, Integer>>> parteIzquierda, String[] atril, int x, int y) {
